...
export const metadata: Metadata = {
  ...
  description:
    "Professional asphalt paving, sealcoating, striping, thermoplastic markings, driveways, parking lots, patching, and free estimates.",
  keywords: [
    "asphalt",
    "sealcoating",
    "striping",
  ...
  openGraph: {
    ...
    description: "Built smooth. Finished sharp. Professional pavement work and free estimates.",
    type: "website",
